...
const BasicFooter: React.FC<Props> = ({ text, onClick, disabled=false, secondButtonText, onClickSecond }) => {

  return (
    <IonFooter className={`${secondButtonText ? 'footer-div-one-button' : 'buttons-footer'}`} style={{paddingBottom: `${isPlatform("ios") ? '50px' : '0px'}`}}>
